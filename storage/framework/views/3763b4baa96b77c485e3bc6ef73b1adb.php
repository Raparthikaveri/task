...
<form method="post" action="<?php echo e(route('ball.save')); ?>" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
...
<?php echo $__env->make('sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\test_tms\resources\views/ballform.blade.php ENDPATH**/ ?>